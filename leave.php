                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">To the University Secretary/Accounting Officer</p>
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Name of the applicant</label>
                                            <textarea class="form-control" name="description" type="text" name="description" length="400" id="example-text-input" rows="1"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Designation</label>
                                            <textarea class="form-control" name="description" type="text" name="description" length="400" id="example-text-input" rows="1"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Department/Unit/Section</label>
                                            <textarea class="form-control" name="description" type="text" name="description" length="400" id="example-text-input" rows="1"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Name of the staff left to take charge</label>
                                            <textarea class="form-control" name="description" type="text" name="description" length="400" id="example-text-input" rows="1"></textarea>
                                        </div>
                                        <!-- Insert the table with five rows and five columns -->
                                        
                                        <caption style="text-align: center; font-weight: bold;">LEAVE REQUEST INFORMATION</caption>
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Date of last leave taken</label>
                                        ...
                                        <p>Specify the types of leave you are applying for, the dates on which to apply it and the total leave Days.</p>
                                        <div class="form-group">
                                            <label class="col-form-label">TYPE OF LEAVE</label>
